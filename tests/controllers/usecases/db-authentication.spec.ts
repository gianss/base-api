import { EncrypterSpy, HashComparerSpy } from '@/tests/mocks/mock-cryptography'
import { DbAuthentication } from '@/controllers/account/usecases/db-authentication'
import { LoadAccountByEmailRepositorySpy, UpdateAccessTokenRepositorySpy } from '@/tests/mocks/mock-db-account'
...
describe('DbAuthentication UseCase', () => {
  ...
  test('Should return null if LoadAccountByEmailRepository returns null', async () => {
    ...
    const model = await sut.auth(mockAddAccountParams())
  ...
  test('Should call Encrypter with correct plaintext', async () => {
    ...
    expect(encrypterSpy.plaintext.toString()).toBe(loadAccountByEmailRepositorySpy.result.id.toString())
  })
